...
<aside class="sidebar" id="sidebar">
  ...
  <ul class="sidebar-nav">
    <li><a href="./" data-page="index.php">
      <svg class="nav-icon"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
      Home
    </a></li>
    <li><a href="./" data-page="index.php">
      <svg class="nav-icon"><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/></svg>
      Categories
    </a></li>
    <li><a href="all_products.php" data-page="all_products.php">
      <svg class="nav-icon"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>
      Products
    </a></li>
    <li><a href="cart.php" data-page="cart.php">
      <svg class="nav-icon"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>
      Cart
    </a></li>
    ...
    <li><a href="staff_stock_take.php" data-page="staff_stock_take.php">
      <svg class="nav-icon"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 14l2 2 4-4"/></svg>
      Stock Take
    </a></li>
    <li><a href="staff_stock_loss.php" data-page="staff_stock_loss.php">
      <svg class="nav-icon"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
      Stock Loss
    </a></li>
    ...
    <li><a href="account.php" data-page="account.php">
      <svg class="nav-icon"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Account'); ?>
    </a></li>
    <li><a href="logout.php" style="color:#fca5a5;">
      <svg class="nav-icon" style="stroke:#fca5a5;"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
      Logout
    </a></li>
  </ul>
</aside>
