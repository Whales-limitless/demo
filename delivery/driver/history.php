			...
			<div class="row">
				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h1 class="h2">History <small>(Job done & Completed)</small></h1>
						<!--
					...
					<div id="mydiv">
						...
						<?php
						$sql = $connect->query("SELECT * FROM del_orderlist WHERE DRIVERCODE = '$drivercode' AND STATUS = 'D' OR DRIVERCODE = '$drivercode' AND STATUS = 'C' ORDER BY DELDATE DESC");
						...
						<div class="card text-center border border-dark">
							...
							if($remark == ""){
								...
								<div class="btn-group" role="group" >
									...
									<button class="btn btn-warning btn-lg " data-bs-toggle="modal" data-bs-target="#exampleModal_<?php echo $row["ID"]; ?>">Item</button>
