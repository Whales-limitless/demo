...
<html lang="en">
    <head>
		...
		<title>Driver Detail Report</title>
	...
	<body>
			...
			<div class="row">
				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h1 class="h2">Driver Detail Report</h1>
                    ...
                    <div class="row">
                        <input type="hidden" id="ptitle" value="Driver Detail Report">
						<div class="col-md-2">
					...
					<table id="example" class="table table-striped table-hover" style="width:100%">
						<thead>
							<tr>
								...
								if($type == 1){
								?>
								<th style="text-align:right">Distant</th>
						...
						<tbody>
							...
							$sql = $connect->query("SELECT *,CAST(DONEDATETIME as time) AS DONEAT FROM `del_orderlist` WHERE DRIVERCODE = '".$_COOKIE["parkwaydelivery_driver"]."' AND (STATUS = 'D' OR STATUS = 'C') AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
							...
							while($row = $sql->fetch_assoc()){
								...
								<tr>
									...
									if($type == 1){
									?>
									<td style="text-align:right"><?php echo $row["DISTANT"]; ?></td>
									<td style="text-align:right"><?php echo $row["RETAIL"]; ?></td>
									<?php
									}
									?>
									<?php
						...
						<tfoot>
							<?php
							$sql12 = $connect->query("SELECT SUM(DISTANT) AS SUMDISTANT,SUM(RETAIL) AS SUMRETAIL FROM `del_orderlist` WHERE DRIVERCODE = '".$_COOKIE["parkwaydelivery_driver"]."' AND (STATUS = 'D' OR STATUS = 'C') AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
							if($sql12->num_rows > 0){
		...
		function submit() {
			...
			location.href = "?s="+sdate+"&e="+edate+"&l="+location2+"&t="+type;
		}
		</script>
	</body>
</html>
