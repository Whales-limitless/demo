...
$sdate = $_GET["sdate"] ?? $last7;
$edate = $_GET["edate"] ?? $datenow;
?>
<!doctype html>
<html lang="en">
	<head>
			...
			<div class="row">
				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h1 class="h2">Dashboard <span class="badge bg-primary">Completed</span></h1>
					...
					<div id="mydiv">
						<form method="GET">
							<div class="row">
								<div class="col-md-3">
									From<input type="date" name="sdate" id="sdate" value="<?php echo $sdate; ?>" class="form-control">
								</div>
								<div class="col-md-3">
									To<input type="date" name="edate" id="edate" value="<?php echo $edate; ?>" class="form-control">
								</div>
								<div class="col-md-3">
									<br>
						...
						<div class="table-responsive">
							<table class="table table-striped table-sm">
								...
								<tbody>
									<?php
									$sql = $connect->query("SELECT orderlist.*, customer.ADDRESS FROM orderlist LEFT JOIN customer ON orderlist.CUSTOMERCODE = customer.CODE WHERE orderlist.STATUS = 'C' AND orderlist.DELDATE >= '$sdate' AND orderlist.DELDATE <= '$edate' ORDER BY orderlist.DELDATE ASC");
									...
									<tr>
										...
										<td>
											<div class="btn-group" role="group" aria-label="Basic mixed styles example">
												...
												<!--
			<button class="btn btn-success btn-sm" <?php if($row["STATUS"] == "" || $row["STATUS"] == "A"){echo "disabled";} ?> onclick="complete('<?php echo $row["ID"]; ?>')" disabled>Complete</button>-->
											</div>
										</td>
									</tr>
									<!-- Modal -->
