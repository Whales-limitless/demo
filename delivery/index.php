			...
			<div class="row">
				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h1 class="h2">Dashboard <span class="badge bg-primary">Order</span></h1>
					...
					<div id="mydiv">
						...
						<div class="table-responsive">
							<table class="table table-striped table-sm">
								...
								<tbody>
									<?php
									$sql = $connect->query("SELECT orderlist.*, customer.ADDRESS FROM orderlist LEFT JOIN customer ON orderlist.CUSTOMERCODE = customer.CODE WHERE orderlist.STATUS = '' ORDER BY orderlist.DELDATE ASC");
