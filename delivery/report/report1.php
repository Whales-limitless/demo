				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
					...
					<table id="example" class="table table-striped table-hover" style="width:100%">
						...
						<tbody>
							...
							$sql = $connect->query("SELECT *,CAST(DONEDATETIME as time) AS DONEAT FROM `orderlist` WHERE STATUS = 'C' AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
						...
						<tfoot>
							<?php
							$sql12 = $connect->query("SELECT SUM(DISTANT) AS SUMDISTANT,SUM(RETAIL) AS SUMRETAIL FROM `orderlist` WHERE STATUS = 'C' AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
							if($sql12->num_rows > 0){
