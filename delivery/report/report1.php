				...
				<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="row">
						...
						<div class="col-md-2">
							...
							<select class="w-100" id="driver">
								...
								<?php
								$sql79 = $connect->query("SELECT ID, `USER_NAME` AS NAME FROM `sysfile` WHERE `TYPE` = 'D' ORDER BY `USER_NAME` ASC");
					...
					<table id="example" class="table table-striped table-hover" style="width:100%">
						...
						<tbody>
							...
							$sql = $connect->query("SELECT *,CAST(DONEDATETIME as time) AS DONEAT FROM `del_orderlist` WHERE (STATUS = 'D' OR STATUS = 'C') AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
						...
						<tfoot>
							<?php
							$sql12 = $connect->query("SELECT SUM(DISTANT) AS SUMDISTANT,SUM(RETAIL) AS SUMRETAIL FROM `del_orderlist` WHERE (STATUS = 'D' OR STATUS = 'C') AND DELDATE BETWEEN '".$sdate."' AND '".$edate."' $ttxt1 $ttxt2 ");
							if($sql12->num_rows > 0){
