...
$query12 = $connect->query("SELECT ORDNO FROM `sign` WHERE ORDNO = '".$ordno."'");
...
$sanitized_ordno = preg_replace('/[\/\\\\:*?"<>|]/', '_', $ordno);
	...
	<div id="wrap" class="d-none d-sm-block" >
        <div class="container">
            ...
            <div class="d-print-none">
                <div class="row">
                    <div class="col-md-2">
                        <a href="#" onclick="history.back();" class="btn btn-md btn-success">
                            Back
                        </a>
                    </div>
                    <div class="col-md-2 offset-8 d-none d-sm-block" style="text-align:right">
                        <button type="button" class="btn btn-md btn-primary" onclick="printpage()">
                            Print
                        </button>
                    </div>
                </div>
                    ...
                    <div style="width: 30%; display: table-cell;">
                        <div style="width: 100%; display: table;">
                            <div style="display: table-row">
								...
								if($chk == 'Y'){
									?>
									<img src="../driver/sign/doc_signs/<?php echo $sanitized_ordno?>.png" style="width:100%" >
									<?php
								}
								?>
                                </div>
	...
	<div id="wrap" class="d-block d-sm-none">
        <div class="container">
            ...
            <div class="d-print-none">
                <div class="row">
                    <div class="col-md-12">
                        <a href="deliverorder.php" class="btn btn-sm btn-success w-100">
                            Back
                        </a>
                    </div>
                </div>
