...
<input type="hidden" id="ordno" value="<?php echo $ordno; ?>">
<div class="container">
	<br>
	<div id="signArea">
	...
	<div class="row">
		...
		<div class="col-12 col-md-2">
			<a href="vieworder.php?id=<?php echo $_GET['id']; ?>" class="btn btn-md btn-danger w-100">
				Cancel
			</a>
		</div>
	</div>
...
$("#save").click(function(e){
	...
	html2canvas([document.getElementById('sign-pad')], {
		onrendered: function (canvas) {
			...
			$.ajax({
				url: 'signsave.php',
				data: { img_data:img_data,ordno:ordno,gid:gid },
				type: 'post',
				dataType: 'json',
				success: function (response) {
				   if(response == '1'){
					   alert("Success");
					   window.location.href="vieworder.php?id="+gid;
				   }else{
					   alert("Failed");
				   }
				}
