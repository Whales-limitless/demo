 ...
 <button type="button" class="btn btn-sm btn-outline-secondary">Export</button>
					...
					<div class="row">
						...
						<select id="status" class="form-select" style="padding:0px">
						  ...
						  <option value="" <?php if($getstatus == ""){echo "selected";} ?> >All</option>
						  <option value="O" <?php if($getstatus == "O"){echo "selected";} ?> >Ordered</option>
						  <option value="A" <?php if($getstatus == "A"){echo "selected";} ?> >Assigned</option>
						  <option value="D" <?php if($getstatus == "D"){echo "selected";} ?> >Done</option>
						  <option value="C" <?php if($getstatus == "C"){echo "selected";} ?> >Completed</option>
						</select>
						</div>
					...
					<table id="example" class="table table-striped" style="width:100%">
						...
						<tbody>
							...
							<tr>
								...
								if($row["STATUS"] == "D"){
									echo '<span class="badge bg-warning">Done</span>';
								}
								if($row["STATUS"] == "C"){
