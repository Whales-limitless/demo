...
$currentPage = 'report_sales_product';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
    <div class="page-header">
        <h1><i class="fas fa-box-open" style="color:var(--primary);margin-right:8px;"></i>Sales by Product Report</h1>
    </div>
...
function renderTable(rows) {
    ...
    var html = '<table id="reportTable" class="table table-striped table-sm" style="width:100%;font-size:13px;">' +
        '<thead><tr><th>No</th><th>Barcode</th><th>Description</th><th class="text-end">Qty Sold</th><th class="text-end">Orders</th><th class="text-end">Days Sold</th></tr></thead><tbody>';
    ...
    rows.forEach(function(r, i) {
        ...
        html += '<tr>' +
            ...
            '<td class="text-end">' + (r.days_sold || 0) + '</td>' +
            '</tr>';
    });

    html += '</tbody><tfoot><tr style="font-weight:700;"><td colspan="3">TOTAL</td><td class="text-end">' + totalQty.toFixed(2) + '</td><td class="text-end">' + totalOrders + '</td><td></td></tr></tfoot></table>';
