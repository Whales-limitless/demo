...
function fetchCompany() {
    return new Promise(function(resolve) {
        $.ajax({
            type: 'POST', url: 'po_ajax.php', data: { action: 'get_company' }, dataType: 'json',
...
function printPO(id) {
    Promise.all([
        $.ajax({ type: 'POST', url: 'po_ajax.php', data: { action: 'get', id: id }, dataType: 'json' }),
        fetchCompany()
